...
class Autoencoder:
    ...
    def _add_conv_layers(self, encoder_inputs):
        """Creates all convolutional blocks in eoncoder."""
        x = encoder_inputs
...
class VAE:
    ...
    def _add_bottleneck(self, x):
        ...
        def sample_point_from_normal_distribution(args):
            ...
            epsilion = K.random_normal(shape=K.shape(self.mu), mean=0., stddev=1.)
            sampled_point = mu + K.exp(log_variance / 2) * epsilion
